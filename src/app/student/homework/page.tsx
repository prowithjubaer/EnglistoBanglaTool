...
export default function Page() {
  ...
  useEffect(() => { fetch('/api/student/homework').then(r=>r.json()).then(setData) }, [])
  ...
  return (<div className="space-y-6"><h1 className="text-2xl font-bold text-navy bangla-text">📋 হোমওয়ার্ক</h1>
