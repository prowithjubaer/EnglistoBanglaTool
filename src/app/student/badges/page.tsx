...
export default function Page() {
  ...
  useEffect(() => { fetch('/api/student/badges').then(r=>r.json()).then(setData) }, [])
  ...
  return (<div className="space-y-6"><h1 className="text-2xl font-bold text-navy bangla-text">🏆 ব্যাজ</h1>
