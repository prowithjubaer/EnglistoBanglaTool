...
export default function AdminPage() {
  ...
  useEffect(() => { fetch('/api/admin/levels').then(r=>r.json()).then(d=>{setData(d);setLoading(false)}).catch(()=>setLoading(false)) }, [])
  ...
  return (<div className="space-y-6"><h1 className="text-2xl font-bold text-navy capitalize">levels</h1>
