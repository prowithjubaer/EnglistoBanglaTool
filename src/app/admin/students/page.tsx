...
export default function AdminPage() {
  ...
  useEffect(() => { fetch('/api/admin/students').then(r=>r.json()).then(d=>{setData(d);setLoading(false)}).catch(()=>setLoading(false)) }, [])
  ...
  return (<div className="space-y-6"><h1 className="text-2xl font-bold text-navy capitalize">students</h1>
